...
// 구 버전의 메모 관리 함수 - 더 이상 사용하지 않음
// 메모는 이제 queryMemoUtils.ts의 전용 컬렉션에서 관리됨
...
// 구 버전의 메모 조회 함수 - 더 이상 사용하지 않음
// 메모 조회는 이제 queryMemoUtils.ts의 getQueryMemo 함수를 사용

// 구 버전의 메모 리스트 조회 함수 - 더 이상 사용하지 않음
// 메모 리스트는 이제 queryMemoUtils.ts의 getAllQueryMemos 함수를 사용